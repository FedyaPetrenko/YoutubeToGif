...
namespace WebApplication1.Controllers
{
    public class HomeController : Controller
    {
        public ActionResult Index()
        {
            ...
            //ffmpeg.ConvertLiveMedia(stream, Format.mp4, @"C:\Downloads\result2.gif", null, new ConvertSettings() { VideoFrameRate = 1, MaxDuration = 10 });
            System.IO.Stream stream2 = new System.IO.MemoryStream();
            ffmpeg.ConvertLiveMedia(stream, Format.mp4, stream2, Format.gif, new ConvertSettings() { VideoFrameRate = 1, MaxDuration = 10 });
            return View();
        }
